...
<%@ include file="nav.jsp" %>
 ...
 <h3 class="mt-5 mb-4 text-center">Check Out</h3>

<sql:query dataSource="${db_con}" var="rs">  
SELECT * from reservations_checkout;  
</sql:query>  
   
<table class="table table-danger table-striped " width="100%">  
<tr>  
...
<td class="text-capitalize"><c:out value="${table.act_check_out}"/></td>
